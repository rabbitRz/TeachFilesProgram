...
<body>
 ...
 <%
     	Application application1=(Application)request.getAttribute("application1");   		
     %>
    ...
    <div class="modal-content">
     ...
     已经成功删除
      ...
      <div class="modal-footer">
       ...
       <a href="GetApplicationServlet?teacher_id=<%=application1.getTeacher_id()%>"> <button type="button" class="btn btn-primary">确定</button></a>
      </div>
    </div>
  </div>
