                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">  
							...
							<form class="needs-validation" novalidate action="<%=request.getContextPath() %>/ProjectAddServlet" method="post">
							<table class="table table-bordered table-hover definewidth m10" >
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" id="pro_category" name="pro_category">
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label class="col-sm-2 control-label">开始时间</label>
                                      <div class="col-sm-10">
                                          <input type="Date" class="form-control" id="pro_starttime" name="pro_starttime">
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label class="col-sm-2 control-label">完成时间</label>
                                      <div class="col-sm-10">
                                          <input type="Date" class="form-control" id="pro_finishtime" name="pro_finishtime">
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="pro_identification" >
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label class="col-sm-2 control-label">获奖情况</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="pro_prize" >
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label class="col-sm-2 control-label">排名</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="pro_ranking" >
                                      </div>
                                  </div>
                                  <!-- <div class="form-group row">
