...
/**
 * Servlet implementation class AdminUpdateCourseInfoServlet
 * 课程信息更新
 */
@WebServlet("/AdminUpdateCourseInfo")
public class AdminUpdateCourseInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUpdateCourseInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!daoImpl.GetTrDay(teacher_id, xinqi, course_hour, startweek, endweek, term_start).isRes()) {
			...
			//进行更新
			flag=daoImpl.UpdateCourseById(course_id, course_name, course_class, course_hour, peoplenum, place, teacher_id, startweek, endweek, xinqi, term_start);
			if(flag) {
				str="更新成功！";
			}else {
				str="更新失败！";
