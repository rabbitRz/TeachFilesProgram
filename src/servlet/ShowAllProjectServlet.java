...
/**
 * Servlet implementation class ShowAllProjectServlet
 */
public class ShowAllProjectServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list=dao.showProjects();
		request.setAttribute("projects", list);
		request.getRequestDispatcher("admin/ProjectManage/showAllProjects.jsp").forward(request, response);
	}
